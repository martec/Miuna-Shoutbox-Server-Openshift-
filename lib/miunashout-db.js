...
exports.saveMsg = function(data, cb){
	var newMsg = new Chat({msg: xss(data.msg), nickto: data.nickto, uid: data.uid, uidto: data.uidto, suid: data.suid, nick: data.nick, edt: '0', stylesheet: data.stylesheet, type: data.type, created: data.created});
...
exports.updpml = function(data, cb){
	pml.findOneAndUpdate({uid: data.uid}, { nick: data.nick, nicks: data.nicks }, {upsert: true}).exec();
};
